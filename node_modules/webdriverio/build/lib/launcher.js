...
var Launcher = (function () {
    ...
    _createClass(Launcher, [{
        ...
        value: function startInstance(specs, caps, cid) {
            ...
            var capExecArgs = [].concat(_toConsumableArray(config.execArgv || []), _toConsumableArray(caps.execArgv || []));
            ...
            var execArgv = [].concat(_toConsumableArray(defaultArgs), debugArgs, _toConsumableArray(capExecArgs));
            ...
            childProcess.send({
                ...
                argv: this.argv,
                caps: _extends({}, caps, { processNumber: processNumber }),
                specs: specs,
